...
if (isset($_POST["btn_purchase_code"])) {
	...
	$_SESSION["license_code"] = 'NulledBY-Null-Jung-le9c-nulljungle.com34';
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter Purchase Code" required>NulledBY-Null-Jung-le9c-nulljungle.c</textarea>
                                            </div>
